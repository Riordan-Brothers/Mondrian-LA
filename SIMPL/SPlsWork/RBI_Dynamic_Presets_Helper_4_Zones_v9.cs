...
namespace UserModule_RBI_DYNAMIC_PRESETS_HELPER_4_ZONES_V9
{
    public class UserModuleClass_RBI_DYNAMIC_PRESETS_HELPER_4_ZONES_V9 : SplusObject
    {
...
public UserModuleClass_RBI_DYNAMIC_PRESETS_HELPER_4_ZONES_V9 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
