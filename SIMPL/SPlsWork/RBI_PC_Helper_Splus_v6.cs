...
namespace UserModule_RBI_PC_HELPER_SPLUS_V6
{
    public class UserModuleClass_RBI_PC_HELPER_SPLUS_V6 : SplusObject
    {
...
public UserModuleClass_RBI_PC_HELPER_SPLUS_V6 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
